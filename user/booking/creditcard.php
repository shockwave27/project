...
<form id="payment-form" action="ticket/dist/ticket_insert.php" method="post">
...
<input type="hidden" name="username" value="<?php echo isset($username) ? $username : ''; ?>">
        <input type="hidden" name="fullname" value="<?php echo isset($fullname) ? $fullname : ''; ?>">
        <input type="hidden" name="email" value="<?php echo isset($email) ? $email : ''; ?>">
        <input type="hidden" name="ticket-quantity" value="<?php echo isset($numberOfTickets) ? $numberOfTickets : '1'; ?>">
        <input type="hidden" name="total-price" value="<?php echo isset($ticketPrice) ? $ticketPrice : '0';?>">
        <input type="hidden" name="bookdate" value="<?php echo isset($bookdate) ? $bookdate : '0';?>">
  ...
  <br>
  <button type="submit" id="confirm-payment-btn" style="background-color: green; color: white;">Confirm Payment</button>
    </form>
</div>
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/imask/3.4.0/imask.min.js'></script><script  src="creditcard.js"></script>
